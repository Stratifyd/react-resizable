...
var ResizableBox = function (_React$Component) {
  ...
  ResizableBox.prototype.componentDidMount = function componentDidMount() {
  ...
  ResizableBox.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement('div', _extends({ ref: 'box', style: { width: this.state.width + 'px', height: this.state.height + 'px' } }, props))
    );
  };
